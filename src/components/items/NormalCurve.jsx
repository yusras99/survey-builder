...
class NormalCurve extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      triCent1: Math.round((0.5 * this.props.data["len1"]) * 7) + 7,
      triCent2: Math.round((0.5 * this.props.data["len2"]) * 7) + 7,
      mousePointerRange: 0,
      triDown: false,
      ...
      colLim1: Math.round((500 - (this.props.data["len1"] * 7)) / 7),
      colLim2: Math.round((500 - (this.props.data["len2"] * 7)) / 7),
  ...
  triDrag(e) {
    ...
    if (this.state.triDown === 2) {
      ...
      if (col < 0) {
        ...
        this.setState({ distancing2: this.state.distancing * 55, col21: this.state.colLim2, col22: this.state.colLim2 + this.state.len2 - 1 })
      }
      else {
      ...
      if (col < 0) {
        ...
        this.setState({ distancing1: this.state.distancing * 55, col11: this.state.colLim1, col2: this.state.colLim1 + this.state.len1 - 1 })
      }
      else {
  ...
  render() {
    return (
      <div
        ...
        {/* <h1>Mouse coordinates: { this.state.x } { this.state.y } {this.state.svgX} {Math.round((this.state.svgX - 6) / 7)} | Triangle Tip: {this.state.triCent2 + this.state.distancing2} | Tip-Mouse Distance: {this.state.mousePointerRange}</h1> */}
