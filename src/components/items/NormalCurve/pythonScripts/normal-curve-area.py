...
height_1 = int(input('What is the height of the first curve? '))
width_1 = int(input('What is the width of the first curve? '))
height_2 = int(input('What is the height of the second curve? '))
width_2 = int(input('What is the width of the second curve? '))
radius = int(input('What is the radius of each circle (minimum is 2, maximum is 5) '))
axis_length = int(input('What is the default length of the x-axis (at least 1, default is 30) '))
low_val = int(input("What is the value of the lowest value of our x-axis? (the highest value will be the lowest value + the length of the axis) "))
